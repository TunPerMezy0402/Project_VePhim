    ...
    <div class="card-header">
        <div class="row flex-between-center">
            <div class="col-12 col-md-6 col-xl-5 d-flex align-items-center gap-3 flex-wrap">
                ...
                <form action="{{ route('admin.countries.index') }}" method="GET" class="w-100 w-md-auto">
            ...
            <div class="col-8 col-sm-auto text-end ps-2">
                <div id="table-customers-replace-element">
                    <!-- Nút New -->
                    <a href="{{ route('admin.countries.create') }}" class="btn btn-falcon-default btn-sm me-2">
                        <span class="fas fa-plus" data-fa-transform="shrink-3 down-2"></span>
                        <span class="d-none d-sm-inline-block ms-1">New</span>
                    </a>

                    <!-- Nút Thùng Rác -->
                    <a href="{{ route('admin.countries.trash') }}" class="btn btn-falcon-default btn-sm me-2">
            ...
            <table class="table table-sm table-striped fs-10 mb-0 overflow-hidden">
                ...
                <tbody class="list" id="table-customers-body">
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="joined align-middle py-2">
                            <a href="{{ route('admin.countries.edit', $country->id) }}">Chỉnh Sửa</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
