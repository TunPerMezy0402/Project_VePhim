        ...
        <div class="row flex-between-center">
            ...
            <div class="col-8 col-sm-auto text-end ps-2">
                <div id="table-customers-replace-element">
                    ...
                    <a href="{{ route('admin.cinemas.create') }}" class="btn btn-falcon-default btn-sm me-2">
                        <span class="fas fa-plus" data-fa-transform="shrink-3 down-2"></span>
                        <span class="d-none d-sm-inline-block ms-1">New</span>
                    </a>

                    <!-- Nút Thùng Rác -->
                    <a href="{{ route('admin.cinemas.trash') }}" class="btn btn-falcon-default btn-sm me-2">
            ...
            <table class="table table-sm table-striped fs-10 mb-0 overflow-hidden">
                <thead class="bg-200">
                    <tr>
                        ...
                        <th class="text-900 sort pe-1 align-middle white-space-nowrap" data-sort="name">Address</th>
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="name align-middle white-space-nowrap py-2">
                            <a href="{{ route('admin.cinemas.movies.index', $cinema->id) }}">
                                ...
                                <div class="flex-1">
                                    <h5 class="mb-0 fs-10">{{ $cinema->name }}</h5>
                                </div>
                            </div>
                            </a>
                        </td>
                        ...
                        <td class="joined align-middle py-2">
                            {{ optional($cinema->created_at)->format('d/m/Y') }}
                        </td>
                        <td class="joined align-middle py-2">
                            <a href="{{ route('admin.cinemas.edit', $cinema->id) }}">Chỉnh Sửa</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
