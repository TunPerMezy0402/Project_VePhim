    ...
    <div class="card-header">
        <div class="row flex-between-center">
            <div class="col-12 col-md-6 col-xl-5 d-flex align-items-center gap-3 flex-wrap">
                ...
                <form action="{{ route('admin.cinemas.trash') }}" method="GET" class="w-100 w-md-auto">
            ...
            <div class="col-8 col-sm-auto text-end ps-2">
                <div id="table-customers-replace-element">
                    ...
                    <a href="{{ route('admin.cinemas.index') }}" class="btn btn-falcon-default btn-sm me-2">
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="joined align-middle py-2">
                            <div class="d-flex gap-2">
                                ...
                                <form action="{{ route('admin.cinemas.forceDelete', $cinema->id) }}" method="POST"
