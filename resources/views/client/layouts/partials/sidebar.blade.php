                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="fs-11 mb-0 d-flex">
                                                ...
                                                <span class="fw-medium text-600 ms-2">27 Sep at 10:30
                                                    AM</span>
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <a class="notification notification-flush notification-unread" href="#!">
                                            ...
                                            <div class="notification-body">
                                                ...
                                                <span class="notification-time">
                                                    <span class="me-2" role="img" aria-label="Emoji">💬</span>Just
                                                    now</span>
                                            </div>
                                        </a>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 col-xxl-3">
                                        <div class="nav flex-column">
                                            ...
                                            <a class="nav-link py-1 link-600 fw-medium"
                                                href="pages/errors/404.html">404</a>
                                            <a class="nav-link py-1 link-600 fw-medium"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 col-xxl-3">
                                        <div class="nav flex-column">
                                            ...
                                            <a class="nav-link py-1 link-600 fw-medium"
                                                href="pages/faq/faq-basic.html">Faq basic</a>
                                            <a class="nav-link py-1 link-600 fw-medium"
                                                href="pages/faq/faq-alt.html">Faq alt</a>
                                            <a class="nav-link py-1 link-600 fw-medium"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 col-xxl-3">
                                        <div class="nav flex-column">
                                            ...
                                            <a class="nav-link py-1 link-600 fw-medium"
                                                href="modules/charts/d3js.html">D3js
                                                <span class="badge rounded-pill ms-2 badge-subtle-success">New</span>
                                            </a>
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link dropdown-indicator" href="#movies" role="button" data-bs-toggle="collapse"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <span class="nav-link-text ps-1">Movies</span>
                        </div>
                    </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link dropdown-indicator" href="#onemies" role="button" data-bs-toggle="collapse"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="nav-link-text ps-1">Biến thể</span>
                                </div>
                            </a>
                    ...
                    <a class="nav-link dropdown-indicator" href="#e-commerce" role="button" data-bs-toggle="collapse"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <span class="nav-link-text ps-1">Quản lý thương mại</span>
                        </div>
                    </a>
                        ...
                        <div class="list-group list-group-flush fw-normal fs-10">
                            ...
                            <div class="list-group-item">
                                <a class="border-bottom-0 notification-unread  notification notification-flush"
                                    ...
                                    <div class="notification-body">
                                        <p class="mb-1">
                                            <strong>University of Oxford</strong>created an event : "Causal
                                            Inference Hilary 2019"
                                        </p>
                                        <span class="notification-time">
                                            <span class="me-2" role="img" aria-label="Emoji">✌️</span>1w</span>
                                    </div>
                            ...
                            <div class="list-group-item">
                                <a class="border-bottom-0 notification notification-flush" href="#!">
                                    ...
                                    <div class="notification-body">
                                        <p class="mb-1">
                                            <strong>James Cameron</strong>invited to join the group: United
